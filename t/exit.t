...
run_perl(prog => 'use threads 1.55;' .
                 'threads->exit(86);' .
                 'exit(99);',
...
run_perl(prog => 'use threads 1.55 qw(exit thread_only);' .
...
my $out = run_perl(prog => 'use threads 1.55;' .
                           'threads->create(sub {' .
                           '    exit(99);' .
                           '})->join();' .
                           'exit(86);',
...
$out = run_perl(prog => 'use threads 1.55 qw(exit thread_only);' .
                        'threads->create(sub {' .
